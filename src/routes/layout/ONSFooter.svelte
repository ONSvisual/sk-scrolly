	...
	<div class="col-wide" data-analytics="footer">
		...
		<div class="license">
			...
			<a
				...
				target="_blank"
				rel="noopener"
				style="color: {theme['text']}">Open Government Licence v3.0</a>, 
